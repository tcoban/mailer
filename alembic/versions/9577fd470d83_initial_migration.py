...
def upgrade() -> None:
    ...
    sa.Column('response_body', sa.dialects.postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('metadata_fields', sa.dialects.postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('payload_snapshot', sa.dialects.postgresql.JSONB(astext_type=sa.Text()), nullable=True),
